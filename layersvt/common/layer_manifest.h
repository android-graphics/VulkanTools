...
struct LayerManifest {
    ...
    /**
     * Returns a reference to the manifest configuration for compatibility.
     */
    [[nodiscard]] const LayerManifest& GetConfig() const noexcept { return *this; }
};
